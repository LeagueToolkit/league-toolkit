...
///
/// Sealed: implemented for `&'a PropertyValueEnum` and for [`ValueView<'a>`], and by
/// nothing else. A visitor is written against this trait and runs over either tree.
///
/// [`ValueView<'a>`]: crate::stream::ValueView
...
/// [`StructView<'a>`], which an object's root also views as.
///

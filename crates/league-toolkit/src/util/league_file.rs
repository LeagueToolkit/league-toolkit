...
/// Get the league file kind from an extension.
...
/// Get the extension for a league file kind.
...
/// Identify the kind of league file from the provided data.
...
/// Get the ideal compression for a league file.
pub fn get_ideal_compression_for_league_file(kind: LeagueFileKind) -> WadChunkCompression {
    match kind {

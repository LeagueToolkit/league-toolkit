...
- *(ltk_ritobin)* print PTCH text under #PTCH_text and escape record paths
- *(ltk_ritobin)* [**breaking**] parse and print PTCH text

## [0.8.4](https://github.com/LeagueToolkit/league-toolkit/compare/ltk_ritobin-v0.8.3...ltk_ritobin-v0.8.4) - 2026-09-23
...
## [0.8.1](https://github.com/LeagueToolkit/league-toolkit/compare/ltk_ritobin-v0.8.0...ltk_ritobin-v0.8.1) - 2026-09-14

### Fixed

- *(ltk_ritobin)* type expression not checking for eof
...
## [0.8.0](https://github.com/LeagueToolkit/league-toolkit/compare/ltk_ritobin-v0.7.1...ltk_ritobin-v0.8.0) - 2026-09-07

### Added

- feat!(ltk_ritobin): AST ([#185](https://github.com/LeagueToolkit/league-toolkit/pull/185))

## [0.7.1](https://github.com/LeagueToolkit/league-toolkit/compare/ltk_ritobin-v0.7.0...ltk_ritobin-v0.7.1) - 2026-09-01

### Other

- updated the following local packages: ltk_meta

## [0.7.0](https://github.com/LeagueToolkit/league-toolkit/compare/ltk_ritobin-v0.6.0...ltk_ritobin-v0.7.0) - 2026-08-30
...
## [0.6.0](https://github.com/LeagueToolkit/league-toolkit/compare/ltk_ritobin-v0.5.0...ltk_ritobin-v0.6.0) - 2026-08-25

### Added

- *(ritobin)* add Visit::Abort and WalkOutcome::Aborted
- *(ritobin)* [**breaking**] walk outcome reporting and exit_tree sibling pruning
...
- *(ritobin)* [**breaking**] always run exit_tree for entered nodes, even on Stop
- *(ritobin)* [**breaking**] make Span::contains half-open and keep error spans in-bounds
...
- *(ritobin)* move the visitor tests into their own file
- fmt

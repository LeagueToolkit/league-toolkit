...
entries: map[hash, embed] = {
    "Characters/Aatrox/Skins/Skin0" = SkinCharacterDataProperties {
        ...
        skinAudioProperties: embed = skinAudioProperties {
            tagEventList: list[string] = { "Aatrox" }
        ...
        skinMeshProperties: embed = SkinMeshDataProperties {
            ...
            overrideBoundingBox: option[vec3] = { { 130, 250, 130 } }
        ...
        defaultAnimations: list[string] = { "BaseBuffPose" }
        mContextualActionData: link = "Characters/Aatrox/CAC/Aatrox_Base"
        iconCircle: option[string] = { "ASSETS/Characters/Aatrox/HUD/Aatrox_Circle.dds" }
        iconSquare: option[string] = { "ASSETS/Characters/Aatrox/HUD/Aatrox_Square.dds" }
        ...
        complexEmitterDefinitionData: list[pointer] = {
            VfxEmitterDefinitionData {
                ...
                primitive: pointer = VfxPrimitiveAttachedMesh {
                    mMesh: embed = VfxMeshDefinitionData {
                        mSubmeshesToDraw: list[hash] = { "BODY", "Shoulder" }
                    }
                }
                blendMode: u8 = 1
                color: embed = ValueColor {
                    dynamics: pointer = VfxAnimatedColorVariableData {
                        times: list[f32] = { 0, 0.100000001, 0.899999976, 1 }
                        values: list[vec4] = {
                            { 1, 1, 1, 0 }
                            { 1, 1, 1, 1 }
                            { 1, 1, 1, 1 }
            ...
            VfxEmitterDefinitionData {
                ...
                color: embed = ValueColor {
                    ...
                    dynamics: pointer = VfxAnimatedColorVariableData {
                        times: list[f32] = { 0, 0.100000001, 0.800000012, 1 }
                        values: list[vec4] = {
                            { 1, 1, 1, 0 }
                            { 1, 1, 1, 0.650003791 }
                            { 1, 1, 1, 0.650003791 }
    ...
    "Characters/Aatrox/Skins/Skin0/Particles/Aatrox_Base_E_Dash" = VfxSystemDefinitionData {
        complexEmitterDefinitionData: list[pointer] = {
            VfxEmitterDefinitionData {
                ...
                particleLinger: option[f32] = { 0.200000003 }
                lifetime: option[f32] = { 1.10000002 }
                isSingleParticle: flag = true
                emitterName: string = "Avatar"
                ...
                primitive: pointer = VfxPrimitiveAttachedMesh {
                    mMesh: embed = VfxMeshDefinitionData {
                        mSubmeshesToDraw: list[hash] = { "BODY" }
                    }
                }
                blendMode: u8 = 1
                ...
                color: embed = ValueColor {
                    dynamics: pointer = VfxAnimatedColorVariableData {
                        times: list[f32] = { 0, 0.100000001, 0.5, 1 }
                        values: list[vec4] = {
                            { 1, 1, 1, 0 }
                            { 1, 1, 1, 1 }
                            { 1, 1, 1, 0.300007641 }
                ...
                alphaErosionDefinition: pointer = VfxAlphaErosionDefinitionData {
                    erosionDriveCurve: embed = ValueFloat {
                        dynamics: pointer = VfxAnimatedFloatVariableData {
                            times: list[f32] = { 0, 0.200000003, 1 }
                            values: list[f32] = { 0, 0, 0.5 }
                        }
                    }
            ...
            VfxEmitterDefinitionData {
                ...
                primitive: pointer = VfxPrimitiveAttachedMesh {
                    mMesh: embed = VfxMeshDefinitionData {
                        mSubmeshesToDraw: list[hash] = { "Sword" }
                    }
                }
                blendMode: u8 = 1
                birthColor: embed = ValueColor {
            ...
            VfxEmitterDefinitionData {
                ...
                primitive: pointer = VfxPrimitiveAttachedMesh {
                    mMesh: embed = VfxMeshDefinitionData {
                        mSubmeshesToDraw: list[hash] = { "Wings" }
                    }
                }
                blendMode: u8 = 1
                birthColor: embed = ValueColor {
    ...
    "Characters/Aatrox/Skins/Skin0/Particles/Aatrox_Base_P_Ready" = VfxSystemDefinitionData {
        complexEmitterDefinitionData: list[pointer] = {
            VfxEmitterDefinitionData {
                ...
                color: embed = ValueColor {
                    dynamics: pointer = VfxAnimatedColorVariableData {
                        times: list[f32] = { 0, 0.400000006, 1 }
                        values: list[vec4] = {
                            { 1, 1, 1, 0 }
                            { 1, 1, 1, 1 }
                            { 0.330006868, 0, 0, 1 }
                    ...
                    dynamics: pointer = VfxAnimatedVector3fVariableData {
                        probabilityTables: list[pointer] = {
                            VfxProbabilityTableData {
                                ...
                                keyValues: list[f32] = { 0, 360 }
                            }
                            VfxProbabilityTableData { }
                            VfxProbabilityTableData { }
                            }
                        times: list[f32] = { 0 }
                        values: list[vec3] = { { 1, 0, 0 } }
                    }
                }
                birthScale0: embed = ValueVector3 {
                    ...
                    dynamics: pointer = VfxAnimatedVector3fVariableData {
                        probabilityTables: list[pointer] = {
                            VfxProbabilityTableData {
                                keyTimes: list[f32] = { 0, 1 }
                                keyValues: list[f32] = { 0.5, 1 }
                            }
                            VfxProbabilityTableData { }
                            VfxProbabilityTableData { }
                            }
                        times: list[f32] = { 0 }
                        values: list[vec3] = { { 150, 100, 100 } }
                    }
                }
                        ...
                        mDrivers: list[pointer] = {
                            FloatGraphMaterialDriver {
                                ...
                                graph: embed = VfxAnimatedFloatVariableData {
                                    times: list[f32] = { 0.00171930937, 0.216738746, 0.766768217, 1.00488436 }
                                    values: list[f32] = { -0.22144419, 0.260138661, 0.752247512, 0.86541003 }
                                }
                            }
                            FloatGraphMaterialDriver {
                                driver: pointer = LerpMaterialDriver {
                                    mBoolDriver: pointer = IsAnimationPlayingDynamicMaterialBoolDriver {
                                        mAnimationNames: list[hash] = { "Passive_Death" }
                                    }
                                    mTurnOnTimeSec: f32 = 3
                                }
                                graph: embed = VfxAnimatedFloatVariableData {
                                    times: list[f32] = { 0.00321787666, 0.381477386, 0.997775316 }
                                    values: list[f32] = { -0.225780264, 0.583815038, 0.994219661 }
                                }
                            }
                            }
                    }
                        ...
                        mElements: list[embed] = {
                            ...
                            SwitchMaterialDriverElement {
                                mCondition: pointer = IsAnimationPlayingDynamicMaterialBoolDriver {
                                    mAnimationNames: list[hash] = { 0x909068b6 }
                                }
                                mValue: pointer = LerpMaterialDriver {
                                    mBoolDriver: pointer = IsAnimationPlayingDynamicMaterialBoolDriver {
                                        mAnimationNames: list[hash] = { 0x909068b6 }
                            ...
                            SwitchMaterialDriverElement {
                                mCondition: pointer = IsAnimationPlayingDynamicMaterialBoolDriver {
                                    mAnimationNames: list[hash] = { "taunt" }
                                }
                                mValue: pointer = LerpMaterialDriver {
                                    mBoolDriver: pointer = IsAnimationPlayingDynamicMaterialBoolDriver {
                                        mAnimationNames: list[hash] = { "taunt" }

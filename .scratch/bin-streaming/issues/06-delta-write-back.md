...
- **Size discrepancies veto nothing here.** A base object with a lying size field is copied exactly as its declared range states, which reproduces the input byte for byte.
